...
class Ui_UpdateDialog(object):
    ...
    def retranslateUi(self, UpdateDialog):
        ...
        self.titleLabel.setText(QCoreApplication.translate("UpdateDialog", u"New Version Detected", None))
        ...
        self.noButton.setText(QCoreApplication.translate("UpdateDialog", u"Later", None))
        self.yesButton.setText(QCoreApplication.translate("UpdateDialog", u"Download This Version", None))
    # retranslateUi
